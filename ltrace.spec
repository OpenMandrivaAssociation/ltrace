...
Patch6: ltrace-0.8.1-breakpoint-on_install.patch
Patch7: ltrace-0.8.1-ppc64-unprelink.patch
 
# Man page nits.  Backport of an upstream patch.
Patch8: ltrace-0.8.1-man.patch
 
# https://bugzilla.redhat.com/show_bug.cgi?id=1044766
Patch9: ltrace-0.8.1-cant_open.patch
 
# Support Aarch64 architecture.
Patch10: ltrace-0.8.1-aarch64.patch
...
Patch15: ltrace-0.8.1-parser-ws_after_id.patch
...
Patch16: ltrace-0.8.1-ppc-bias.patch
 
# https://bugzilla.redhat.com/show_bug.cgi?id=1158714
Patch17: ltrace-0.8.1-x86-plt_map.patch
Patch18: ltrace-0.8.1-x86-unused_label.patch
 
# https://bugzilla.redhat.com/show_bug.cgi?id=1170315
Patch19: ltrace-0.8.1-unwind-elfutils.patch
...
Patch20: ltrace-0.8.1-multithread-no-f-1.patch
Patch21: ltrace-0.8.1-multithread-no-f-2.patch
...
Patch22: ltrace-0.8.1-testsuite-includes.patch
Patch23: ltrace-0.8.1-testsuite-includes-2.patch
...
Patch28: ltrace-0.8.1-aarch64-params.patch
 
# gcc-9 fix.  Avoid passing NULL as argument to %s
Patch29: ltrace-0.8.1-null.patch
 
# Adds support for CET PLTs via second-plt lookups.
Patch30: ltrace-0.8.1-cet.patch
 
# Extra #includes for gcc 9
Patch31: ltrace-0.8.1-aarch64-headers.patch
...
Patch33: ltrace-0.8.1-testsuite-system_call_params.patch
 
# Ignore bogus files from the environment
Patch34: ltrace-0.8.1-XDG_CONFIG_DIRS.patch

Patch100: ltrace-0.8.1-aarch64-extra-structs.patch
